            ...
            <div class="tableContainer">
                <table>
                    ...
                    <tbody>
                        ...
                        ?>
                                    <tr>
                                        <td><img class='tableImg' alt='Avatar' src="<?php if ($row['imageURL'] !== "") {
                                                                                        echo $row['imageURL'];
                                                                                    } else {
                                        ...
                                        <td>
                                            <div><?php echo number_format(($row['price'] * $row['quantity'] * (1 - ($row['sale']) / 100)), 0, ',', ' ') ?> Ft</div>
                                        </td>
                                        <td>
                                            <div><button onclick="decreaseQuantity(<?php echo $row['id_cart'] ?>)">-</button><?php echo $row['quantity'] ?><button onclick="increaseQuantity(<?php echo $row['id_cart'] ?>)">+</button></div>
                                        </td>
                                        <td>
                                            <div><button class='deleteButton' onclick="removeFromCart(<?php echo $row['id_cart'] ?>)"><img class="deleteCartIcon" src="assets/delete_dark.svg" /></button></div>
                                        </td>
                                    </tr>
