...
<body>
    <header>
        ...
        <div class="headerButtonsContainer">
            <button class="headerButton" id="saveProductsButton" disabled>
                Mentés
            </button>
            <button class="headerButton" id="addProductButton">
                Új termék
            </button>
        </div>
    </header>
                    ...
                    <tr name="<?php echo $row["id"] ?>" id="tableRow_final_<?php echo $i ?>">
                        ...
                        <td>
                            <div class="tableCheckboxContainer">
                                <img id="tableRow_final_image_<?php echo $i ?>" class="indexPic" alt="<?php if ($row['imageURL'] == '') {
                                                                                                            echo "assets/placeholder.svg";
                                                                                                        } else {
                                                                                                            echo $row['imageURL'];
                                                                                                        } ?>" src="<?php if ($row['imageURL'] == '') {
                                                                                                                                                                                                                    echo "assets/placeholder.svg";
                                                                                                                                                                                                                } else {
                                                                                                                                                                                                                    echo $row['imageURL'];
                                                                                                                                                                                                                } ?>" />
                        ...
                        <td><select name="tableInputCPU" id="tableInputCPU_${currentIndex}" class="tableInput tableInputSelect">
                                <option <?php if ($row['CPU'] == 0) {
                                            echo "selected";
                                        } ?>>...</option>
                                <option <?php if ($row['CPU'] == 1) {
                                            echo "selected";
                                        } ?>>i3</option>
                                <option <?php if ($row['CPU'] == 2) {
                                            echo "selected";
                                        } ?>>i5</option>
                                <option <?php if ($row['CPU'] == 3) {
                                            echo "selected";
                                        } ?>>i7</option>
                                <option <?php if ($row['CPU'] == 4) {
                                            echo "selected";
                                        } ?>>i9</option>
                            </select></td>
                        <td><select name="tableInputGPU" id="tableInputGPU_${currentIndex}" class="tableInput tableInputSelect">
                                <option <?php if ($row['GPU'] == 0) {
                                            echo "selected";
                                        } ?>>...</option>
                                <option <?php if ($row['GPU'] == 1) {
                                            echo "selected";
                                        } ?>>Nvidia GeForce RTX 3050</option>
                                <option <?php if ($row['GPU'] == 2) {
                                            echo "selected";
                                        } ?>>Nvidia GeForce RTX 3060</option>
                                <option <?php if ($row['GPU'] == 3) {
                                            echo "selected";
                                        } ?>>Nvidia GeForce RTX 3070</option>
                                <option <?php if ($row['GPU'] == 4) {
                                            echo "selected";
                                        } ?>>Nvidia GeForce RTX 3080</option>
                                <option <?php if ($row['GPU'] == 5) {
                                            echo "selected";
                                        } ?>>Nvidia GeForce RTX 3090</option>
                                <option <?php if ($row['GPU'] == 6) {
                                            echo "selected";
                                        } ?>>Nvidia GeForce RTX 4060</option>
                                <option <?php if ($row['GPU'] == 7) {
                                            echo "selected";
                                        } ?>>Nvidia GeForce RTX 4070</option>
                                <option <?php if ($row['GPU'] == 8) {
                                            echo "selected";
                                        } ?>>Nvidia GeForce RTX 4080</option>
                                <option <?php if ($row['GPU'] == 9) {
                                            echo "selected";
                                        } ?>>Nvidia GeForce RTX 4090</option>
                            </select></td>
                        <td><select name="tableInputMEMORY" id="tableInputMEMORY_${currentIndex}" class="tableInput tableInputSelect">
                                <option <?php if ($row['MEMORY'] == 0) {
                                            echo "selected";
                                        } ?>>...</option>
                                <option <?php if ($row['MEMORY'] == 1) {
                                            echo "selected";
                                        } ?>>2 GB</option>
                                <option <?php if ($row['MEMORY'] == 2) {
                                            echo "selected";
                                        } ?>>4 GB</option>
                                <option <?php if ($row['MEMORY'] == 3) {
                                            echo "selected";
                                        } ?>>8 GB</option>
                                <option <?php if ($row['MEMORY'] == 4) {
                                            echo "selected";
                                        } ?>>16 GB</option>
                                <option <?php if ($row['MEMORY'] == 5) {
                                            echo "selected";
                                        } ?>>32 GB</option>
                                <option <?php if ($row['MEMORY'] == 6) {
                                            echo "selected";
                                        } ?>>64 GB</option>
                            </select></td>
                        <td><select name="tableInputOPSYSTEM" id="tableInputOPSYSTEM_${currentIndex}" class="tableInput tableInputSelect">
                                <option <?php if ($row['OPSYSTEM'] == 0) {
                                            echo "selected";
                                        } ?>>...</option>
                                <option <?php if ($row['OPSYSTEM'] == 1) {
                                            echo "selected";
                                        } ?>>Windows (64bit)</option>
                                <option <?php if ($row['OPSYSTEM'] == 2) {
                                            echo "selected";
                                        } ?>>Windows 10 (64bit)</option>
                                <option <?php if ($row['OPSYSTEM'] == 3) {
                                            echo "selected";
                                        } ?>>Windows 11 (64bit)</option>
                            </select></td>
                        <td>
                            <div class="tableInputContainer">
                                <input name="tableInputSTORAGE" id="tableInputSTORAGE_${currentIndex}" placeholder="Minimum tárhely (GB)" type="number" class="tableInput tableInputPrice" value="<?php if ($row['STORAGE_GB'] == 0) {
                                                                                                                                                                                                        echo "";
                                                                                                                                                                                                    } else {
                                                                                                                                                                                                        echo $row['STORAGE_GB'];
                                                                                                                                                                                                    } ?>">
                        ...
                        <td><select name="tableInputCategory" id="tableInputCategory_${currentIndex}" class="tableInput tableInputSelect">
                                <option <?php if ($row['category_id'] == 0) {
                                            echo "selected";
                                        } ?>>...</option>
                                <option <?php if ($row['category_id'] == 1) {
                                            echo "selected";
                                        } ?>>PC</option>
                                <option <?php if ($row['category_id'] == 2) {
                                            echo "selected";
                                        } ?>>Playstation</option>
                                <option <?php if ($row['category_id'] == 3) {
                                            echo "selected";
                                        } ?>>Xbox</option>
                                <option <?php if ($row['category_id'] == 4) {
                                            echo "selected";
                                        } ?>>Nintendo</option>
                            </select></td>
                        <td>
