  ...
  <body>
    ...
    <div class="productDetailsBuyContainer">
        <div class="productDetailsBuyContentContainer">
            ...
            <div class="productDetailsPriceContainer"><p class="productDetailsPrice" ><?php echo number_format(($product->price * (1 - ($product->sale) / 100)), 0, ',', ' ') ?> Ft<?php if($product->sale > 0){ echo "<p class='productSaleText'>-$product->sale%</p>"; } ?></p></div>
        </div>
    </div>
